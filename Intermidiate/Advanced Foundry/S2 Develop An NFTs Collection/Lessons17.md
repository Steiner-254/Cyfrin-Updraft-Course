...
- Pasting this into our browser and checking the imageUri we should be able to verify that this is the Sad tokenUri.. so what's going on?
...
Wait a minute! One of these is returning our tokenURI and the other is our imageURI! This is why it's important to be explicit in our naming conventions! Let's adjust these constants, and our test, right away. We can define a variable with what we expect the tokenURI to be and assert versus that.
